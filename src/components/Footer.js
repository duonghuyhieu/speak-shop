    ...
    <div className='Footer__container'>
        ...
        <div className='Footer__input' >
            ...
            <div className='Footer__order'>
                ...
                <input placeholder='Enter your mobile phone or your order id'>
                </input>
                <button>SEND</button>
            </div>
        </div>
        <div className='Footer__copyright'>
            ...
            <p>Address: 68-70 Nguyen Trai, Thanh Xuan Distric, Ha Noi/ Phone number: 0938188188/ BR no:41C8013931 date 09/03/2011, the place of issuing the People's Committee of Thanh Xuan District </p>
